...
FileToolbar::FileToolbar()
{
    ...
    m_pOpenDICOM = new QAction(QIcon(":Resources/icons/Image.png"), tr("Open DICON image"), this);
    m_pOpenDICOMSeries = new QAction(QIcon(":Resources/icons/ImageSeries.png"), tr("Open DICON Series"), this);
